    ...
    render() {
        ...
        return (
            <div>
                ...
                image={tower}
                type='secondary'
                title={<h3 className='uppercase'>Les <span className='underline underline-secondary'>lieux</span> à découvrir sur la ville de Rennes</h3>}
                />
                ...
                data={place}
                isReverse
                title={<h3 className='uppercase'>Les <span className='underline underline-primary'>actualités</span> de la ville de Rennes</h3>}
                />
